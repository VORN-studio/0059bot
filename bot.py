...
async def start_cmd(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    welcome_text = """
       🎁 РОЗЫГРЫШ 1000 TON 🎁 Победители будут определены на основе:

        Вашей личной активности в игре.

        Активности ваших рефералов.

        Чем больше играете вы и ваша команда, тем выше шанс забрать главный приз!

        👉 Чтобы начать, нажми кнопку «DOOMINO» рядом с чатом.
        """
